...
GS_CREDENTIALS = service_account.Credentials.from_service_account_file(
   os.path.join(BASE_DIR, 'meeting-app-and-ocr-47e08cbd45d6.json')
)

# Google Cloud Storage configuration
DEFAULT_FILE_STORAGE = 'storages.backends.gcloud.GoogleCloudStorage'
GS_BUCKET_NAME = 'meeting-app-and-ocr.appspot.com'
...
# EMAIL_FROM = 'neharapolu7115@gmail.com'
EMAIL_HOST_USER = 'neharapolu7115@gmail.com'
EMAIL_HOST_PASSWORD = 'lfbw dtaa hvzw orzd'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
#MEDIA_URL = '/media/'
# Media files URL
MEDIA_URL = 'https://storage.googleapis.com/meeting-app-and-ocr.appspot.com/'
